...
async function main() {
    ...
    await prisma.product.create({
        data: {
            ...
            mainImageUrl: "https://via.placeholder.com/800x1000.png?text=Product+Image",
            categoryId: ustgiyim.id,
            ...
            images: {
                create: [
                    {
                        imageUrl: "https://via.placeholder.com/800x1000.png?text=Product+Image",
                        displayOrder: 1,
                    },
                    {
                        imageUrl: "https://via.placeholder.com/800x1000.png?text=Product+Image",
    ...
    console.log("✅ Admin user created (email: admin@Kiosk QR.com, password: admin123)");
